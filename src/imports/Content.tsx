import svgPaths from "./svg-uh1sqmbpjt";
...
export default function Content() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start pb-[48px] pt-0 px-0 relative size-full" data-name="Content">
      <Frame19 />
      <Container />
    </div>
  );
