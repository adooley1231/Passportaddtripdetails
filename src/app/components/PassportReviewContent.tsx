// This component matches the exact Figma design for Review Passport Details
import svgPaths from "../../imports/svg-uh1sqmbpjt";
...
function SelectedTextIcon() {
  return (
    <div className="content-stretch flex h-[24px] items-center justify-between relative shrink-0 w-full" data-name="Selected text + icon">
      <Text />
      <Helper additionalClassNames="shrink-0 size-[16px] relative" />
    </div>
  );
}
...
export function PassportReviewContent() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start pb-[48px] px-0 relative w-full" data-name="Content">
      <Frame19 />
      <Container />
    </div>
  );
